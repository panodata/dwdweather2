...
def run():
    ...
    def get_station(args):
        dw = DwdWeather(resolution=args.resolution, category_names=args.categories, cache_path=args.cache_path, reset_cache=args.reset_cache)
    ...
    for parser in [parser_station, parser_stations, parser_weather]:
        ...
        parser.add_argument("--resolution", type=str, choices=resolutions_available, default="hourly",
        ...
        parser.add_argument("--categories", type=str, nargs='*', choices=categories_available,
        ...
        parser.add_argument("-c", dest="cache_path", default=default_path,
